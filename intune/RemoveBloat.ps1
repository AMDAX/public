...
invoke-webrequest -uri "https://raw.githubusercontent.com/AMDAX/public/main/intune/SetACL.exe" -outfile "C:\Windows\Temp\SetACL.exe"
...
# Download Source
$URL = 'https://github.com/AMDAX/public/raw/main/intune/mcafeeclean.zip'
